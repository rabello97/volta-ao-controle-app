  ...
  return (
    <div className="flex flex-col gap-1.5 border-b border-divider py-3 last:border-b-0">
      ...
      <div className="h-1.5 overflow-hidden rounded-[3px] bg-track">
        <div
          className={cn("h-full rounded-[3px]", barTone(item.usedPct))}
  ...
  return (
    <section className="flex flex-col gap-3 rounded-[18px] border border-divider bg-surface px-4 py-5 shadow-[var(--shadow-card)] sm:px-[22px]">
      <div className="flex flex-wrap items-baseline gap-2">
        <h2 className="text-[14.5px] font-semibold text-text">Orçamento do mês</h2>
        <span className="text-[11.5px] text-text-4">Renda contra o que já saiu</span>
      </div>
